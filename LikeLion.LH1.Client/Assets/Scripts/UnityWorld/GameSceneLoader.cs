...
namespace LikeLion.LH1.Client.UnityWorld
{
    public class GameSceneLoader
    {
        ...
        public async void Load()
        {
            ...
            var scene = instance.GetComponent<GameScene>();
            ...
            var board = new Core.OmokScene.Checkerboard(checkerBoard, _logger);
            ...
            var host = new OmokHost(board, players, new Core.Timer(_time, loop), 5, mainUIPanel);
